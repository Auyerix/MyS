...
source C:/Working/MyS/lab2b/Sintesis/lab2b/lab2b.sdk/system_wrapper_hw_platform_1/ps7_init.tcl
targets -set -nocase -filter {name =~"APU*" && jtag_cable_name =~ "Digilent Arty Z7 003017A4C8ABA"} -index 0
loadhw -hw C:/Working/MyS/lab2b/Sintesis/lab2b/lab2b.sdk/system_wrapper_hw_platform_1/system.hdf -mem-ranges [list {0x40000000 0xbfffffff}]
...
rst -processor
targets -set -nocase -filter {name =~ "ARM*#0" && jtag_cable_name =~ "Digilent Arty Z7 003017A4C8ABA"} -index 0
dow C:/Working/MyS/lab2b/Sintesis/lab2b/lab2b.sdk/TestApp/Debug/TestApp.elf

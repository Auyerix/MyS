...
HD_PWD='C:/Working/MyS/Sistema_PLC/Sintesis/sistema_plc.runs/sistema_protocheck3_ip_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sistema_protocheck3_ip_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sistema_protocheck3_ip_0_0.tcl

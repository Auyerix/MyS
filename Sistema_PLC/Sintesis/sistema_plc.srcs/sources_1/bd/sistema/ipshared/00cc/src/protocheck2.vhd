...
entity protocheck is
	...
	port(
		...
		rst_i	: in std_logic;
		ena_i	: in std_logic;
		data_o	: out std_logic_vector(N-1 downto 0);-- := "100010110001"; 	--salida del shift register
...
begin
    ...
    begin
		if rst_i = '1' then
            ...
            if is_ok = '1'  then
				data_o	<= auxi;  -- Almacena el valor de data_in

            -- Si enable es '0', no hace nada y mantiene el valor almacenado
			end if;
        end if;
    end process;

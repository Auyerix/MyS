...
HD_PWD='C:/Working/MyS/Sistema_Sumador_IP/Sintesis/sistema_sumador.runs/sistema_sum_ip_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sistema_sum_ip_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sistema_sum_ip_0_0.tcl

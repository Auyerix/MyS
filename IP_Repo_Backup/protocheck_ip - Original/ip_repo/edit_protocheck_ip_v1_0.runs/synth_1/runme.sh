...
HD_PWD='c:/working/mys/ip_repo/protocheck_ip/ip_repo/edit_protocheck_ip_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log protocheck_ip_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source protocheck_ip_v1_0.tcl
